...
tap_dance_action_t tap_dance_actions[] = {
    [TD_L_SQ_BR] = ACTION_TAP_DANCE_DOUBLE(KC_Y, KC_LBRC),
    [TD_R_SQ_BR] = ACTION_TAP_DANCE_DOUBLE(KC_U, KC_RBRC)
};
...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                    TD(TD_L_SQ_BR) /*KC_Y*/,    TD(TD_R_SQ_BR)/*KC_U*/,    KC_I,    KC_O, KC_P,  KC_MINS,
